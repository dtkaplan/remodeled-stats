...
These have become the central questions of the data-driven workplace.

## *"You're wrong. Our courses do include those things."*

This claim is mistaken.  My methodology to demonstrate this:
...
- Don't we insist on the mantra "*correlation is not causation*"?
...
- [Snidely.] Do we use a computer in our class?
...
Remarkably, I've never heard anyone object to the recommendations in GAISE. Is there a consensus?

## The "post p < 0.05 world"

This is more controversial, but it is hardly a fringe movement.

Have you ever met an intro stats instructor who says, "I'm going to try moving p-values from the center of my course?"
...
ii. About statistics
    a. Statistics is fundamentally about making sense of data with an eye toward communicating to decision makers.
    b. A century's experience has shown that real situations involve multiple variables and potential confounding, and statistical methods help deal with this complexity.
...
## It's all really one method. Let's work with that.




[Regression Little App](https://maa-statprep.shinyapps.io/Little_App_Regression/). I'll explain the "Little App" business in a little bit.
